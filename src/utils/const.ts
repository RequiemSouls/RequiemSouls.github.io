...
const MAPBOX_TOKEN =
  ...
  'pk.eyJ1Ijoic2Nod2FyenMiLCJhIjoiY202cDMzNjFqMHlweTJrcTBmemZycmpvYyJ9.4H0QrD-Xxnw-gDuzubdaQQ';
...
const CHINESE_INFO_MESSAGE = (yearLength: number, year: string): string => {
  ...
  return `骑车 ${yearLength} 年了，下面列表展示的是${yearStr}的数据`;
};
...
const CHINESE_LOCATION_INFO_MESSAGE_FIRST =
  '享受痛苦，承受自由';
const CHINESE_LOCATION_INFO_MESSAGE_SECOND = 'No Pain No Gain';
...
const RIDING_TITLE = IS_CHINESE ? '骑行' : 'Riding';
